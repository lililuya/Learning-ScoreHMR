...
backlist_mp_path = "/mnt/hd3/liwen/DATA_for_HMR/VggFace2/black_list/backlist_mediapipe.txt"
backlist_68_path = "/mnt/hd3/liwen/DATA_for_HMR/VggFace2/black_list/backlist_68.txt"
processed_path_list = "/mnt/hd3/liwen/DATA_for_HMR/VggFace2/black_list/processed.txt"

def generate_crop_image(image_dir, lmk_dir, dense_lmk_dir, tform_dir, out_par_dir):
    image_list = sorted(glob(image_dir + '/*/*.jpg') +  glob(image_dir + '/*/*.png'))
    ...
    for image_path in tqdm(image_list):
        ...
        if dense_lmk is None:
            with open(backlist_mp_path, "a") as mp_file:
                mp_file.write(image_path + "\n")
                print(image_path, " is detected none mp landmark")
                continue
        if bbox is None:
            with open(backlist_68_path, "a") as ld_file:
...
if __name__=="__main__":
    ...
    parser.add_argument('--recovery', type=bool, required=False, default=True, help="Recovery from exception, skip the processed files")

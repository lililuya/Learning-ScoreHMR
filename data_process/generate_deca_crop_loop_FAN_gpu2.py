...
backlist = "/mnt/hd3/liwen/DATA_for_HMR/VggFace2/black_list/gpu2/backlist_lmk.txt"
processed_path_list = "/mnt/hd3/liwen/DATA_for_HMR/VggFace2/black_list/gpu2/processed.txt"

def generate_crop_image(image_dir, lmk_dir, dense_lmk_dir, tform_dir, out_par_dir):
    image_list = sorted(glob(image_dir + '/*/*.jpg') +  glob(image_dir + '/*/*.png'))[600000:1200000]
